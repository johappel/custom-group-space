...
class OpenAIClient {
    ...
    /**
     * Setzt die Systemnachricht für das LLM
     * @param $message
     */
    ...
    /**
     * Alias für chat() aus Kompatibilitätsgründen
     * @param $userMessage
     * @return string
     */
    ...
    /**
     * Alias für json() aus Kompatibilitätsgründen
     * @param $userMessage
     * @return array
     */
    ...
    /**
     * Sendet eine Chat-Nachricht an die OpenAI-Chat-API, erwartet eine Textantwort
     * @param $userMessage
     * @return string
     */
    ...
    /**
     * Sendet eine Chat-Nachricht und erwartet eine JSON-Antwort
     * @param $userMessage
     * @return array JSON-Daten oder Fehlermeldung
     */
